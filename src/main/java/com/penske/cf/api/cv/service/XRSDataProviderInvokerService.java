...
@Slf4j
public class XRSDataProviderInvokerService implements ExternalDataProviderInvokerService {

	private HttpGatewayExecutorFactory executorFactory;
	
	public XRSDataProviderInvokerService(HttpGatewayExecutorFactory  executorFactory) {
	...
	public List<Map<String,String>> getAssetList(DataProviderCustIntgtnCfgDetails customerData) {
		...
		HttpGatewayExecutor httpGatewayExecutor = executorFactory.getHttpGatewayExecutor("xrs", EndPointType.ENDPOINT);
